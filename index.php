...
<html lang="en">
    ...
    <body>
        <div itemscope itemtype="http://schema.org/Service">
            <meta itemprop="serviceType" content="Garage Door Repair" />
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="box">
                            <div class="col-lg-12 text-center">
                                <div id="carousel-example-generic" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img class="img-responsive img-full" src="img/Therma-elite.jpg" alt="New Garage Door, Utah">
                                        </div>
                                        <div class="item">
                                            <img class="img-responsive img-full" src="img/Modern-Classic.jpg" alt="Aluminum Garage Door, Utah">
                                        </div>
                                        <div class="item">
                                            <img class="img-responsive img-full" src="img/Infinity-Classic.jpg" alt="Wood Looking Garage Door, Utah">
                                        </div>
                                    </div>
                                ...
                                <h2>
                                    <small>
                                        <strong>Locally Owned and Operated Garage Door Repair and Installation Company
                                        </strong>
                                    </small>
                                </h2>
                            </div>
                    ...
                    <div class="row">
                        <div class="box">
                            <div class="col-lg-12">
                                    ...
                                    should attempt to adjust, repair, or service door equipment. Call us today for fast friendly service!<a href="tel:1-801-888-4359" class="linked-phone-number"> 801.888.4359</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="box">
                            <div class="col-lg-12">
                                <hr>
                                <h2 class="intro-text text-center"><a href="about.php">About Us
                                    <strong>Why we do what we do</strong></a>
                                </h2>
                                <hr>
